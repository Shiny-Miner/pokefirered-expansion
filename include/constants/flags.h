...
#define FLAG_SYS_NO_ENCOUNTER       0x021
#define FLAG_SYS_NO_TRAINER_SEE     0x022
#define FLAG_SYS_NO_BAG_USE         0x023
#define FLAG_SYS_NO_CATCHING        0x024
#define FLAG_SYS_PC_FROM_DEBUG_MENU 0x025
